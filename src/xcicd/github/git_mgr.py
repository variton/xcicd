...
class GitMgr:
    ...
    def __init__(self, _repo: str, _token: str) -> None:
        """Initialize git manager object."""
        self.repo_ = _repo
        self.token_ = _token

    def remove_branch(self,current_branch:str) -> None:
        """Remove current branch."""
        # create api delete method 
        delete_api_method = ApiMgr.create_delete_api_method(self.repo_, _current_branch)
        # create curl command 
